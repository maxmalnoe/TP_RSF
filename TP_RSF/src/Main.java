...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		List<Paquet> listp4 = Flux.createFlux("flux2");
		List<Paquet> listp5 = Flux.createFlux("flux1");
		
		
		while(qsource.size()<40) {
			Source.fillListAttente(qsource,Source.chooseList(listp1, listp2, listp3, listp4, listp5));
		}
